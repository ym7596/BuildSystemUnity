...
namespace FlutterUnityIntegration.Editor
{
    public class Build : EditorWindow
    {
        ...
        private static readonly string AndroidExportPath = Path.GetFullPath(Path.Combine(ProjectPath, "../myflutterviewer/android/unityLibrary"));
        private static readonly string WindowsExportPath = Path.GetFullPath(Path.Combine(ProjectPath, "../myflutterviewer/windows/unityLibrary/data"));
        private static readonly string IOSExportPath = Path.GetFullPath(Path.Combine(ProjectPath, "../myflutterviewer/ios/UnityLibrary"));
        private static readonly string WebExportPath = Path.GetFullPath(Path.Combine(ProjectPath, "../myflutterviewer/web/UnityLibrary"));
        private static readonly string IOSExportPluginPath = Path.GetFullPath(Path.Combine(ProjectPath, "../myflutterviewer/ios_xcode/UnityLibrary"));
...
#unity-mobile-warning { position: absolute; left: 50%; top: 5%; transform: translate(-50%); background: white; padding: 10px; display: none }
        ...
        */
        ...
        {
            var androidPath = Path.GetFullPath(Path.Combine(ProjectPath, "../myflutterviewer/android"));
            var androidAppPath = Path.GetFullPath(Path.Combine(ProjectPath, "../myflutterviewer/android/app"));
...
";
        ...
        {
            var iosRunnerPath = Path.GetFullPath(Path.Combine(ProjectPath, "../myflutterviewer/ios"));
